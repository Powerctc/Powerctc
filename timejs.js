...
var countDownDate0 = new Date("Oct 12, 2024 18:00:00").getTime();
...
<!--live-2-->
// Set the date we're counting down to
var countDownDate1 = new Date("Sept 14, 2024 18:00:00").getTime();
...
<!--live-3-->
// Set the date we're counting down to
var countDownDate2 = new Date("Sept 14, 2024 20:30:00").getTime();
...
<!--live-4-->
// Set the date we're counting down to
var countDownDate3 = new Date("Sept 14, 2024 20:30:00").getTime();
...
<!--live-5-->
// Set the date we're counting down to
var countDownDate4 = new Date("Sept 14, 2024 23:00:00").getTime();
...
<!--live-6-->
// Set the date we're counting down to
var countDownDate5 = new Date("Sept 11, 2024 00:30:00").getTime();
...
<!--live-7-->
// Set the date we're counting down to
var countDownDate6 = new Date("Sept 9, 2024 1:15:00").getTime();
...
// Set the date we're counting down to
var countDownDate7 = new Date("june, 2023 21:00:00").getTime();
